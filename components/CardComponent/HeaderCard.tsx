...
import img2 from "../../app/img/owner.webp";

export default function HeaderCard() {
  return (
    <>
         {/* Profile Header Card */}
          <Card className="mb-6 lg:p-5 border border-gray-200 shadow-none dark:border-gray-800 dark:bg-[#171F2E] rounded-2xl">
            <CardContent className="p-1">
              <div className="flex items-center flex-col  lg:flex-row justify-between">
                <div className="flex items-center flex-col  lg:flex-row gap-6">
                  <Avatar className="w-24 h-24 ">
                    <AvatarImage src={img2.src} className='rounded-full' />
                    <AvatarFallback className="bg-indigo-600 text-white text-2xl">
                      MC
                    </AvatarFallback>
                  </Avatar>
                  <div>
                    <h2 className="text-2xl font-semibold mb-1 text-center lg:text-start">
                      Musharof Chowdhury
                    </h2>
                    <p className="text-gray-500 text-center">
                      Team Manager{" "}
                      <span className="mx-2 hidden lg:inline-block ">|</span>
                      <span className="block my-1 lg:my-0 lg:inline">
                ...
                <div className="flex  flex-col lg:flex-row items-center gap-3">
                  <div className="media flex gap-5 my-4">
                    <a
                      target="_blank"
                      rel="noreferrer"
